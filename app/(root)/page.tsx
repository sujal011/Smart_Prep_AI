...
const [userInterviews,latestInterviews] = await Promise.all([
  ...
  const hasUpcomingInterviews = latestInterviews? latestInterviews.length > 0: null;
    ...
    <>
      <section className='card-cta'>
        <div className='flex flex-col gap-6 max-w-lg'>
          <h3>Get Interview-Ready with AI-Powered Voice Based Interview </h3>
          <p className='text-lg'>
